...
from app.routes.albums import albums_router
...
app.register_blueprint(albums_router, url_prefix='/api/albums')
app.register_blueprint(photo_routes, url_prefix='/api/photos')
app.register_blueprint(comment_routes, url_prefix='/api/comments')
app.register_blueprint(tags_router, url_prefix='/api/tags')
db.init_app(app)
Migrate(app, db)
